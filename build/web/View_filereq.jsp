                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><a class="btn btn-color" href="approve.jsp?uid=<%=rs.getString("uid")%>&uname=<%=rs.getString("uname")%>&fileid=<%=rs.getString("fileid")%>&filename=<%=rs.getString("filename")%>" style="color:seagreen ">Accept</a></td>
                                </tr>
                            </tbody>
                            <%                                        }
                                } catch (Exception ex) {

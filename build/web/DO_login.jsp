                ...
                <div class="container">
                    <div class="row">
                        <div class="aligncenter">
                            <h3>Data Owner Login</h3><br><br>
                        </div>
                        <div class="span6">
                            <img src="img/owner.jpg" width="100%"/>
                        </div>
                        <div class="span6">
                            <form id="contactform" action="do_signin.jsp" method="post" class="contactForm">
                                <div class="row">
                                    ...
                                    <div class="span6 margintop10 field form-group">
                                        <button class="btn btn-color btn-large margintop10" type="submit">Login</button>&nbsp;&nbsp;&nbsp;
                                        <a href="do_signup.jsp" class="btn btn-primary btn-large margintop10">Register!</a>
                                    </div>
                                </div>
                            </form>
                        </div>

            ...
            <section id="content">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="span4">
                            <img src="img/uploadd.gif" width="100%" />
                        </div>
                        <div class="span6">
                            <form id="contactform" action="upload" method="post" enctype="multipart/form-data" class="contactForm">
                                <div class="row">
                                    <div class="span6 margintop10 field form-group">
                                        <label>Enter Multiple File Keyword :</label>
                                        <input type="text" name="keyword" placeholder="eg : file, keyword" required="required" /><br>
                                    </div><br>
                                    <div class="span6 margintop10 field form-group">
                                    ...
                                    <div class="span6 margintop10 field form-group">
                                        <button class="btn btn-success btn-large margintop10" type="submit">Upload</button>
                                    </div>
                                </div>
                            </form>
                        </div>

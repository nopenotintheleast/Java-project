                ...
                <div class="container">
                    <div class="row">
                        <div class="aligncenter">
                            <h3>Data User Login</h3><br><br>
                        </div>
                        <div class="span6">
                            <img src="img/user.jpg" />
                        </div>
                        <div class="span6">
                            <form id="contactform" action="du_signin.jsp" method="post" class="contactForm">
                                <div class="row">
                                    ...
                                    <div class="span6 margintop10 field form-group">
                                        ...
                                        <a href="du_signup.jsp" class="btn btn-primary btn-large margintop10">Register!</a>
                                    </div>
                                </div>
                            </form>
                        </div>

...
public class data_upload extends HttpServlet {
     ...
     */
    File file;
    final String filepath = "E:/fileuploads/";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String en_filekeyword = e.encrypt(filekeyword, secretKey);
            ...
            System.out.println("Check------------------------------------------------------------------>>>>>");
                ...
                int i = st.executeUpdate("insert into do_files(doid, doname, enc_data, dkey, time, filekeyword, filename, data, enc_filekeyword, enc_time)values('" + doid + "','" + doname + "','" + encryptedtext + "','" + Dkey + "','" + time + "','" + filekeyword+ "','" + file.getName() + "','" + sb.toString() + "','"+ en_filekeyword +"','"+ encryptTime +"')");
                if (i != 0) {

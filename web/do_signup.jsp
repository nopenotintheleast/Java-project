                ...
                <div class="container">
                    <div class="row">
                        <div class="aligncenter">
                            <h3>Data Owner Register </h3><br><br>
                        </div>
                        <div class="span6">
                            <img src="img/do_reg.gif"/>
                        </div>
                        <div class="span6">
                            <form action="do_reg" method="post" id="contactform" class="contactForm">
                                <div class="row">
                                    ...
                                    <div class="span6 margintop10 field form-group">
                                        ...
                                        <input type="text" name="phone" placeholder="Enter Your Phone No" required="required" /><br>
                                    </div><br>
                                    <div class="span6 margintop10 field form-group">
                                        <label>Address :</label>
                                        <input type="text" name="address" placeholder="Enter Your Address" required="required" /><br>
                                    </div><br>
                                    <div class="span6 margintop10 field form-group">
                                    ...
                                    <div class="span6 margintop10 field form-group">
                                        <button class="btn btn-success btn-large margintop10" type="submit">Sign Up</button>
                                    </div>
                                </div>
                            </form>
                        </div>
